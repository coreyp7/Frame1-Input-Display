...
def modx_check(axis):
    return vertical_modx_check(axis[1]) or horizontal_modx_check(axis[0])

def mody_check(axis):
    return vertical_mody_check(axis[1]) or horizontal_mody_check(axis[0])
...
while run:
    ...
    if ret:
        ...
        formatted_input_info = format_input(formatted_input_info)
        #print(formatted_input_info)
        display_nice(formatted_input_info)
