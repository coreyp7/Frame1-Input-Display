"""
API created exclusively by Rabbid76 (https://github.com/Rabbid76)
"""
import ctypes
...
try:
    ...
    sizeof(JOYCAPS): 728
    """
    joyGetDevCaps_proto = ctypes.WINFUNCTYPE(
        ctypes.c_uint, ctypes.c_uint, ctypes.c_void_p, ctypes.c_uint
    )
    joyGetDevCaps_param = (1, "uJoyID", 0), (1, "pjc", None), (1, "cbjc", 0)
    joyGetDevCaps_func = joyGetDevCaps_proto(
        ("joyGetDevCapsW", winmmdll), joyGetDevCaps_param
    )
    ...
    sizeof(JOYINFOEX): 52
    """
    joyGetPosEx_proto = ctypes.WINFUNCTYPE(
